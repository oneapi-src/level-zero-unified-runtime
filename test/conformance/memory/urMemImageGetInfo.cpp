...
TEST_P(urMemImageGetInfoTest, SuccessFormat) {
    ...
    ASSERT_SUCCESS_OR_OPTIONAL_QUERY(
        urMemImageGetInfo(image, property_name, 0, nullptr, &size),
        property_name);
    ...
    ASSERT_SUCCESS(urMemImageGetInfo(image, property_name, size,
                                     &returned_format, nullptr));
...
TEST_P(urMemImageGetInfoTest, SuccessElementSize) {
    ...
    ASSERT_SUCCESS(
        urMemImageGetInfo(image, property_name, size, &returned_size, nullptr));
