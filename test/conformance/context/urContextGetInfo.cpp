...
TEST_P(urContextGetInfoTest, SuccessAtomicFenceOrderCapabilities) {
  ur_context_info_t info_type = UR_CONTEXT_INFO_ATOMIC_FENCE_ORDER_CAPABILITIES;
  size_t size = 0;
...
TEST_P(urContextGetInfoTest, SuccessAtomicFenceScopeCapabilities) {
  ur_context_info_t info_type = UR_CONTEXT_INFO_ATOMIC_FENCE_SCOPE_CAPABILITIES;
  size_t size = 0;
