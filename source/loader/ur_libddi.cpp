...
__urdlllocal ur_result_t context_t::ddiInit() {
  ...
  if (UR_RESULT_SUCCESS == result) {
    result = urGetBindlessImagesExpProcAddrTable(UR_API_VERSION_CURRENT,
                                                 &urDdiTable.BindlessImagesExp);
  }

  if (UR_RESULT_SUCCESS == result) {
    result = urGetCommandBufferExpProcAddrTable(UR_API_VERSION_CURRENT,
                                                &urDdiTable.CommandBufferExp);
  }

  if (UR_RESULT_SUCCESS == result) {
    result =
        urGetContextProcAddrTable(UR_API_VERSION_CURRENT, &urDdiTable.Context);
  }

  if (UR_RESULT_SUCCESS == result) {
    result =
        urGetEnqueueProcAddrTable(UR_API_VERSION_CURRENT, &urDdiTable.Enqueue);
  }
  ...
  if (UR_RESULT_SUCCESS == result) {
    result = urGetEventProcAddrTable(UR_API_VERSION_CURRENT, &urDdiTable.Event);
  }
  ...
  if (UR_RESULT_SUCCESS == result) {
    result =
        urGetProgramProcAddrTable(UR_API_VERSION_CURRENT, &urDdiTable.Program);
  }
  ...
  if (UR_RESULT_SUCCESS == result) {
    result =
        urGetSamplerProcAddrTable(UR_API_VERSION_CURRENT, &urDdiTable.Sampler);
  }
  ...
  if (UR_RESULT_SUCCESS == result) {
    result =
        urGetUSMExpProcAddrTable(UR_API_VERSION_CURRENT, &urDdiTable.USMExp);
  }
