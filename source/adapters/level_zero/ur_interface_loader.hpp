...
ur_result_t urSetLoggerCallback(ur_adapter_handle_t hAdapter,
                                ur_logger_output_callback_t pfnLoggerCallback,
                                void *pUserData, ur_logger_level_t level);
ur_result_t urSetLoggerCallbackLevel(ur_adapter_handle_t hAdapter,
