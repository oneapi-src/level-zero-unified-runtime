 ...
 * @param[in] SyncPointWaitList List of sync point that are dependencies for
 * the command.
...
// Helper function for common code when enqueuing rectangular memory
// operations to a command-buffer.
