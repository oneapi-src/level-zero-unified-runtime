...
typedef enum ur_device_info_t {
    ...
    UR_DEVICE_INFO_IMAGE_SUPPORT = 29,                                       ///< [::ur_bool_t] images are supported
    ...
    UR_DEVICE_INFO_PARTITION_TYPE = 79,                                      ///< [::ur_device_partition_property_t[]] returns an array of properties
    ...
    UR_DEVICE_INFO_HOST_PIPE_READ_WRITE_SUPPORT = 111,                       ///< [::ur_bool_t] Return true if the device supports enqueueing commands
    ...
    UR_DEVICE_INFO_CLUSTER_LAUNCH_SUPPORT_EXP = 0x1111,                      ///< [::ur_bool_t] return true if enqueue Cluster Launch is supported
    ...
    UR_DEVICE_INFO_BINDLESS_SAMPLED_IMAGE_FETCH_1D_USM_SUPPORT_EXP = 0x2012, ///< [::ur_bool_t] returns true if the device supports fetching USM backed
                                                                             ///< 1D sampled image data.
    UR_DEVICE_INFO_BINDLESS_SAMPLED_IMAGE_FETCH_1D_SUPPORT_EXP = 0x2013,     ///< [::ur_bool_t] returns true if the device supports fetching non-USM
                                                                             ///< backed 1D sampled image data.
    UR_DEVICE_INFO_BINDLESS_SAMPLED_IMAGE_FETCH_2D_USM_SUPPORT_EXP = 0x2014, ///< [::ur_bool_t] returns true if the device supports fetching USM backed
                                                                             ///< 2D sampled image data.
    UR_DEVICE_INFO_BINDLESS_SAMPLED_IMAGE_FETCH_2D_SUPPORT_EXP = 0x2015,     ///< [::ur_bool_t] returns true if the device supports fetching non-USM
                                                                             ///< backed 2D sampled image data.
    UR_DEVICE_INFO_BINDLESS_SAMPLED_IMAGE_FETCH_3D_SUPPORT_EXP = 0x2017,     ///< [::ur_bool_t] returns true if the device supports fetching non-USM
    ...
    UR_DEVICE_INFO_BINDLESS_UNIQUE_ADDRESSING_PER_DIM_SUPPORT_EXP = 0x201A,  ///< [::ur_bool_t] returns true if the device supports unique addressing
                                                                             ///< per dimension.
    UR_DEVICE_INFO_BINDLESS_SAMPLE_1D_USM_SUPPORT_EXP = 0x201B,              ///< [::ur_bool_t] returns true if the device supports sampling USM backed
                                                                             ///< 1D sampled image data.
    UR_DEVICE_INFO_BINDLESS_SAMPLE_2D_USM_SUPPORT_EXP = 0x201C,              ///< [::ur_bool_t] returns true if the device supports sampling USM backed
                                                                             ///< 2D sampled image data.
    UR_DEVICE_INFO_ENQUEUE_NATIVE_COMMAND_SUPPORT_EXP = 0x2020,              ///< [::ur_bool_t] returns true if the device supports enqueueing of native
                                                                             ///< work
    UR_DEVICE_INFO_LOW_POWER_EVENTS_SUPPORT_EXP = 0x2021,                    ///< [::ur_bool_t] returns true if the device supports low-power events.
...
typedef enum ur_exp_peer_info_t {
    UR_EXP_PEER_INFO_UR_PEER_ACCESS_SUPPORT = 0,  ///< [int] 1 if P2P access is supported otherwise P2P access is not
                                                  ///< supported.
    UR_EXP_PEER_INFO_UR_PEER_ATOMICS_SUPPORT = 1, ///< [int] 1 if atomic operations are supported over the P2P link,
